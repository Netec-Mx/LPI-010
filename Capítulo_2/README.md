...
1.	Crear un enlace físico llamado enlace_fisico apuntando a archivoA.txt.
2.	Crear un enlace simbólico llamado enlace_simbolico apuntando a archivoA.txt.
3.	Ejecutar el comando ls -li para observar los números de inodo.
...
1.	Modificar el contenido de enlace_fisico:
Bash
echo "Nueva línea" >> enlace_fisico
2.	Verificar el contenido de archivoA.txt y de enlace_simbolico.
3.	Pregunta de reflexión: Si todos muestran el mismo contenido, ¿estamos ocupando el triple de espacio en el disco?
Tarea C: Ruptura de Enlaces (Simulación de Incidente)
1.	Eliminar el archivo original: rm archivoA.txt.
2.	Intentar leer el contenido de enlace_fisico: cat enlace_fisico.
3.	Intentar leer el contenido de enlace_simbolico: cat enlace_simbolico.
